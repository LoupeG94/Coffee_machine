...
class CoffeeMachineTest(StageTest):
    ...
    def check(self, reply: str, clue: Any) -> CheckResult:
        ...
        if not water:
            return CheckResult.false("There is no line with amount of water")

        if not milk:
            return CheckResult.false("There is no line with amount of milk")

        if not beans:
            return CheckResult.false("There is no line with amount of coffee beans")
